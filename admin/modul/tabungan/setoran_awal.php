...
Customer Service</a></li>
        <li><a href="index.php?m=kelas&s=awal"><i class="fa fa-book"></i>
Jenis Tabungan</a></li>
        ...
        <div class="col-sm-12">
          <div class="well">
          	<form action="" method="POST">
            	...
            	<input type="hidden" name="id_tran">
            </div>
              <div class="form-group">
            	<label>Nomor Rekening</label>
            	<input type="text" id="no_rek" class="form-control" name="no_rek" readonly><span class="input-group-btn">
					...
					<div class="modal-body">
							...
							<table width="100%" class="table table-hover"  id="example">
                                ...
                                <tbody>
										...
										?>
									<tr id="tb_nas" data-no_rek="<?php echo $sa['id']; ?>" data-nama="<?php echo $sa['nama']; ?>" data-jns_tab="<?= $sa['jns_tab']; ?>">
										<td>
											<?php echo $no++; ?>
										</td>
										<td>
