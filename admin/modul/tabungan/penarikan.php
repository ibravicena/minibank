...
Customer Service</a></li>
        <li><a href="index.php?m=kelas&s=awal"><i class="fa fa-book" aria-hidden="true"></i>
Jenis Tabungan</a></li>
        <li class="active"><a href="index.php?m=tabungan&s=awal"><i class="fa fa-money" aria-hidden="true"></i>
Transaksi</a></li>
        ...
        <div class="col-sm-12">
          <div class="well">
            ...
            <i><b><span id="message2" style="color: red;"></span></b></i>
             ...
             <div class="form-group">
              <label>Saldo Pengendapan</label>
              <input type="text" class="form-control" id="pengendapan" readonly name="pengendapan">
            </div>
            <i><b><span id="message2" style="color: red;"></span></b></i>
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <table width="100%" class="table table-hover"  id="example">
                    ...
                    ?>
                  <tr id="tb_tran"  data-no_rek="<?= $sa['id'];?>" data-nama="<?= $sa['nama'];?>" data-jns_tab="<?= $sa['jns_tab'];?>" data-saldo="<?= $sa['saldo'];?>" data-pengendapan="<?= $sa['pengendapan'];?>">
                    <td>
                      <?php echo $no++; ?>
                    </td>
                    <td>
  ...
  <script src="<?= url() ?>vendors/js/bootstrap.min.js"></script>
    ...
    $(document).ready(function(){
      ...
      $(document).on('click', '#tb_tran', function (e) {
        ...
        document.getElementById("pengendapan").value = $(this).attr('data-pengendapan');
        $('#modal').modal('hide');
      }); 
      
      $(document).on('click', '#endButton', function (e) {
        let saldo = document.getElementById("saldo").value;
        let pengendapan = document.getElementById("pengendapan").value;
        let penarikan = document.getElementById("penarikan").value;
        let saldo_akhir = saldo - penarikan;
        let maksimal_penarikan = saldo - pengendapan;


        if(saldo_akhir < pengendapan){
