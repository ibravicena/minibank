  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?m=siswa&s=awal">Customer Service</a></li>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Tambah data nasabah</h5>
  ...
  <div class="col-sm-12">
    <div class="well">
      <form action="" method="POST">
        <label>Cari</label>
        <input type="text" name="cari" placeholder="Cari nama nasabah" class="">
