  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?m=kelas&s=awal">Jenis Tabungan</a></li>
...
Customer Service</a></li>
        <li  class="active"><a href="index.php?m=kelas&s=awal"><i class="fa fa-book" aria-hidden="true"></i>
Jenis Tabungan</a></li>
        <li><a href="index.php?m=tabungan&s=awal"><i class="fa fa-money" aria-hidden="true"></i>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Tambah jenis tabungan</h5>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="jns_tab" aria-describedby="emailHelp" placeholder="Masukkan jenis tabungan">
    <small class="form-text text-muted">Masukkan Jenis Tabungan</small>
  </div>
  <div class="form-group">
    <label>Saldo Pengendapan</label>
    <input type="text" class="form-control" name="pengendapan" aria-describedby="emailHelp" placeholder="Masukkan saldo pengendapan">
