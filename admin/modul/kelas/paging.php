...
$data = mysqli_query($koneksi, "SELECT * FROM tb_jtab");
$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas);

$data_nasabah = mysqli_query($koneksi, "SELECT * FROM tb_jtab LIMIT $halaman_awal, $batas");
$nomor = $halaman_awal+1;

foreach ($data_nasabah as $key):
  ?>
...
<tr>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <b><p class="modal-title" id="edit-siswa<?= $key['id'] ?>" style="text-align: center; font-size: 18px;">Edit Nama Jenis Tabungan</p></b>
                </div>
                <div class="modal-body">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $key['jns_tab'];?>" id="exampleInputEmail1" name="jns_tab" aria-describedby="emailHelp" placeholder="Masukkan jenis tabungan">
    <small class="form-text text-muted">Masukkan jenis tabungan</small>
  </div>
  <div class="form-group">
    <label>Saldo Pengendapan</label>
    <input type="text" class="form-control" value="<?= $key['pengendapan'];?>" name="pengendapan" aria-describedby="emailHelp" placeholder="Masukkan saldo pengendapan">
    <small class="form-text text-muted">Masukkan Saldo Pengendapan</small>
  </div>
