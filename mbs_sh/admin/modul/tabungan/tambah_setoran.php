    ...
    <div class="col-sm-9">
      <!-- Button trigger modal -->
       ...
       <div class="row">
        ...
        <button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal">Cari ID Transaksi</button>
        </span>
            </div>
            <div class="form-group">
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <table width="100%" class="table table-hover"  id="example">
                    ...
                    ?>
                  <tr id="tb_tran" data-id_tabungan="<?= $sa['id_tran'];?>" data-id_siswa="<?= $sa['no_rek'];?>" data-nama="<?= $sa['nama'];?>" data-kelas="<?= $sa['jns_tab'];?>" data-tanggal="<?= $sa['tanggal'];?>" data-saldo="<?= $sa['saldo'];?>">
                    <td>
                      <?php echo $no++; ?>
                    </td>
                    <td>
  ...
  <script src="<?= url() ?>vendors/js/bootstrap.min.js"></script>
    ...
    $(document).ready(function(){
      ...
      $(document).on('click', '#tb_tran', function (e) {
        document.getElementById("id_tran").value = $(this).attr('data-id_tran');
