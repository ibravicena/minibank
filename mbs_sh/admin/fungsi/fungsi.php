...
function insert_siswa(){
	...
	$save = "INSERT INTO tb_nas SET nama='$nama', jns_tab='$jns_tab', alamat='$alamat', notlp='$notlp'";
...
function insert_kelas(){
	...
	return mysqli_query($koneksi, "INSERT INTO tb_jtab (jns_tab) VALUES ('$jns_tab')");
}
...
function edit_kelas(){
	...
	return mysqli_query($koneksi, "UPDATE tb_jtab SET jns_tab = '$jns_tab' WHERE id='$id'");
...
function insert_setoran_awal(){
	...
	if ($row) {
		echo "<div class='alert alert-danger alert-dismissable'>
		 ...
		 $query =  "INSERT INTO tb_tran SET no_rek='$id', nama='$nama',jns_tab='$jns_tab', tanggal='$tanggal', setoran=0, penarikan=0, saldo='$saldo'";
...
function tambah_setoran(){
	...
	if ($row) {
		$query = mysqli_query($koneksi, "UPDATE tb_tran SET  no_rek = '$id', nama='$nama', jns_tab='$jns_tab', tanggal='$tanggal', setoran='$setoran', penarikan=0, saldo='$tambah_saldo' WHERE id_ran='$id_tran'");
		header("location: index.php?m=tabungan&s=print&no_rek=$id");
	}else{
		$query =  "INSERT INTO tb_tran SET no_rek='$id', nama='$nama',jns_tab='$jns_tab', tanggal='$tanggal', setoran='setoran', penarikan=0, saldo='$setoran'";
		 mysqli_query($koneksi, $query);
		 header("location: index.php?m=tabungan&s=print&no_rek=$id");
	}
...
function penarikan_saldo(){
	...
	$query = mysqli_query($koneksi, "UPDATE tb_tran SET  no_rek = '$id', nama='$nama', jns_tab='$jns_tab', tanggal='$tanggal', setoran=0, penarikan='$penarikan', saldo='$penarikan_saldo' WHERE id_tran='$id_tran'");
...
function select_print_siswa(){
  ...
  return mysqli_query($koneksi, "SELECT * FROM tb_nas where no_rek = '$id' ");
}
...
function select_print_tabungan(){
  ...
  return mysqli_query($koneksi, "SELECT * FROM tb_tran where no_rek = '$id' ");
}
